...
/* harmony import */ var _modules_show_info__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/show-info */ "./js/modules/show-info.js");
...
Object(_modules_preloader__WEBPACK_IMPORTED_MODULE_3__["initPreloader"])();
Object(_modules_show_info__WEBPACK_IMPORTED_MODULE_4__["showInfo"])();
...
/* harmony import */ var _utils_resize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/resize */ "./js/utils/resize.js");
...
function initPreloader() {
  ...
  var col2 = document.querySelector('.main-page__col-2');
  var col1 = document.querySelector('.main-page__col-1');
  var lightnings = document.querySelectorAll('.lightning');
  var preloaderLogo = document.querySelector('.preloader__logo');
  var preloaderText = document.querySelector('.preloader__text');
  var classPreloadHide = 'preloader--hide';
  var classPreloadLogo = 'preloader__logo--animate';
  var classPreloadOpacity = 'preloader--opacity';
  var classPreloadTextAnimate = 'preloader__text--animate';
  var col1AnimationClass = 'main-page__col-1--animation';
  var col2AnimationClass = 'main-page__col-2--animation';
  var colorChangeTimer = 1500;
  var preloadTimer = 600;

  function onDisablePreloader(evt) {
    if (evt.key !== 'Enter' && Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["getVariables"])().isDesktopState) {
      return;
    }
  ...
  function animateDino() {
    lightnings.forEach(function (item) {
      var random = Math.floor(Math.random() * Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["getVariables"])().changedColors.length);
      _utils_utils__WEBPACK_IMPORTED_MODULE_1__["colors"].forEach(function (color) {
        item.classList.remove(color);
      });
      item.classList.add(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["getVariables"])().changedColors[random]);
    });
  }
  ...
  Object(_utils_resize__WEBPACK_IMPORTED_MODULE_0__["resizeInit"])(setDesktopListeners, setTabletListeners);
}
...
function showInfo() {
  ...
  var info = document.querySelector('.main-page__col-2');
  var classShow = 'main-page__col-2--show';
  ...
  Object(_utils_resize__WEBPACK_IMPORTED_MODULE_0__["resizeInit"])(desktopSet, tabletSet);
}
...
/*!****************************!*\
  !*** ./js/utils/resize.js ***!
  \****************************/
/*! exports provided: resizeInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "resizeInit", function() { return resizeInit; });
...
function resizeInit(desktopSet, tabletSet) {
  ...
  var changedColors = _toConsumableArray(_utils__WEBPACK_IMPORTED_MODULE_0__["colors"]);

  var isDesktopState = document.documentElement.offsetWidth >= desktopMinWidth;

  function startDesktop() {
    desktopSet();
    isDesktopState = true;
    changedColors = _utils__WEBPACK_IMPORTED_MODULE_0__["colors"].filter(function (color) {
      return color !== 'lightning--white';
    });
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["refreshVariables"])(changedColors, isDesktopState);
  }
...
/*!***************************!*\
  !*** ./js/utils/utils.js ***!
  \***************************/
/*! exports provided: refreshVariables, getVariables, colors */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "refreshVariables", function() { return refreshVariables; });
...
var colors = ['lightning--purple', 'lightning--pink', 'lightning--blue', 'lightning--white'];
var changedColors;
var isDesktopState;
