...
function initPreloader() {
  ...
  function animateDino() {
    lightnings.forEach(function (item) {
      var random = Math.floor(Math.random() * variables.changedColors.length);
      variables.colors.forEach(function (color) {
  ...
  var variables = Object(_utils_resize__WEBPACK_IMPORTED_MODULE_0__["resizeInit"])(setDesktopListeners, setTabletListeners);
}
